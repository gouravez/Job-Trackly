      ...
      {data.map((s) => (
        <div key={s.name} className="flex items-center justify-between text-xs">
          <div className="flex items-center gap-1.5">
            ...
            />
            <span className="text-gray-600 dark:text-dark-tx2">{s.name}</span>
          </div>
...
export default function StatusBreakdownChart() {
  ...
  return (
    <div className="col-span-2 bg-white dark:bg-dark-s1 rounded-2xl border border-gray-100 dark:border-dark-border shadow-sm p-6">
