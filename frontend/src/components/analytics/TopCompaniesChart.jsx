...
export default function TopCompaniesChart() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-6">
      <h3 className="font-bold text-gray-900 dark:text-white mb-5">Top Companies Applied To</h3>
      {topCompanies.length === 0 ? (
        <p className="text-sm text-gray-400 text-center py-10">No applications yet</p>
      ) : (
        <ResponsiveContainer width="100%" height={200}>
          <BarChart data={topCompanies} layout="vertical" margin={{ left: 10, right: 20, top: 0, bottom: 0 }}>
