...
export default function ApplicationsPagination({
  ...
  return (
    <div className="flex items-center justify-between px-5 py-4 border-t border-gray-50 dark:border-dark-s3 bg-white dark:bg-dark-s1">
      ...
      <div className="flex items-center gap-1 text-sm text-gray-500 dark:text-dark-tx2">
        <span>
        ...
        <button
          ...
          disabled={page === 1}
          className="ml-2 p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-dark-s2 disabled:opacity-40 transition-colors"
        >
          <ChevronLeft size={16} />
        </button>
