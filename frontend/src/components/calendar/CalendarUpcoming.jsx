  ...
  return (
    <div className="bg-white dark:bg-[#13161e] rounded-2xl border border-gray-100 dark:border-[#252a3a] shadow-sm p-5">
      <div className="flex items-center gap-2 mb-4">
        <CalendarDays size={15} className="text-[#2f54c8] dark:text-[#6b8ef5]" />
        <h3 className="font-bold text-gray-900 dark:text-[#e8eaf2] text-sm">Next 14 days</h3>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className={cn(
                  ...
                  isEvToday ? 'bg-[#2f54c8]' : 'bg-gray-50 dark:bg-[#1a1e2a] group-hover:bg-gray-100 dark:group-hover:bg-[#1f2436]',
                )}>
                  <span className={cn(
                    'text-[10px] font-semibold leading-none',
                    isEvToday ? 'text-blue-200' : 'text-gray-400 dark:text-[#4e5470]',
                  )}>
                    {evDate.toLocaleDateString('en-US', { month: 'short' }).toUpperCase()}
                  </span>
                  <span className={cn(
                    'text-sm font-bold leading-none mt-0.5',
                    isEvToday ? 'text-white' : 'text-gray-800 dark:text-[#e8eaf2]',
                  )}>
                    {evDate.getDate()}
                  </span>
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-semibold text-gray-900 dark:text-[#e8eaf2] truncate group-hover:text-[#2f54c8] dark:group-hover:text-[#6b8ef5] transition-colors">
                    {ev.company}
                  </p>
