...
export default function QuickAddForm({ status, onSave, onCancel }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl border-2 border-[#2f54c8] dark:border-[#2f54c8] shadow-md p-3 space-y-2.5">
      <input
        autoFocus
        value={company}
        ...
        className="w-full h-9 px-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-sm text-gray-800 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2f54c8]/20 focus:border-[#2f54c8] transition-all"
      />
      <input
        value={role}
      ...
      <div className="flex gap-2 pt-0.5">
        ...
        <button onClick={onCancel}
          className="w-8 h-8 flex items-center justify-center rounded-lg border border-gray-200 dark:border-gray-700 text-gray-400 dark:text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-200 transition-all">
          <X size={13} />
        </button>
      </div>
    </div>
