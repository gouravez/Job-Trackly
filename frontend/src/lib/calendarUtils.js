...
export const STATUS_CHIP = {
  Saved: {
    bg: "bg-gray-100 dark:bg-dark-s2",
    text: "text-gray-500 dark:text-dark-tx2",
    dot: "#6b7280",
  },
  Applied: {
    bg: "bg-blue-50 dark:bg-dark-blue-tint",
    text: "text-blue-600 dark:text-dark-accent3",
    dot: "#3b82f6",
  },
  Assessment: {
    bg: "bg-purple-50 dark:bg-dark-purple-tint",
    text: "text-purple-600 dark:text-purple-400",
    dot: "#8b5cf6",
  },
  Interview: {
    bg: "bg-teal-50 dark:bg-dark-teal-tint",
    text: "text-teal-600 dark:text-teal-400",
    dot: "#14b8a6",
  },
  Offer: {
    bg: "bg-emerald-50 dark:bg-dark-green-tint2",
    text: "text-emerald-600 dark:text-emerald-400",
    dot: "#10b981",
  },
  Rejected: {
    bg: "bg-red-50 dark:bg-dark-red-tint",
    text: "text-red-500 dark:text-red-400",
    dot: "#ef4444",
  },
  FollowUp: {
    bg: "bg-amber-50 dark:bg-dark-amber-tint",
