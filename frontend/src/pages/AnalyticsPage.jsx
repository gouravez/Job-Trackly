    ...
    <DashboardLayout>
      <div className="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
        ...
        <div className="flex items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white">Analytics</h1>
            <p className="text-gray-400 dark:text-gray-500 mt-0.5 text-sm">Track your job search performance</p>
          </div>
          <button className="flex items-center gap-2 h-9 sm:h-10 px-3 sm:px-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors whitespace-nowrap">
