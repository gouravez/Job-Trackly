    ...
    <DashboardLayout>
      <div className="p-4 sm:p-6 lg:p-8 space-y-5">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white">Calendar</h1>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-4">
          ...
          <div className="space-y-4">
            ...
            <CalendarUpcoming  upcoming={upcoming} todayStr={todayStr} onSelectDay={setSelectedDay} />
            <CalendarMonthStats year={year} month={month} applications={applications} eventMap={eventMap} />
            <GoogleCalendarCard />
          </div>
